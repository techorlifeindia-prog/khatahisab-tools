    ...
    <div className="w-full max-w-4xl mx-auto px-4 py-12 md:py-16">
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-rose-50 text-rose-600 shrink-0">
            <RefreshCcw className="w-5 h-5" />
          </div>
          <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">Refund Policy</h1>
        </div>
